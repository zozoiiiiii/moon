...
LPCTSTR CGameFrameWnd::GetWindowClassName() const { return _T("UIMainFrame"); };
UINT CGameFrameWnd::GetClassStyle() const { return CS_DBLCLKS; };
void CGameFrameWnd::OnFinalMessage(HWND /*hWnd*/) { delete this; };
...
LPCTSTR CGameFrameWnd::GetItemText(CControlUI* pControl, int iIndex, int iSubItem)
{
