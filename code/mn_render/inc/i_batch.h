...
// {
// 	MN_VIRTUAL_BEGIN(IBatch, BaseObject);
// 	MN_END
// public:
...
class IBatchGroup : public MN::BaseObject
{
public:
...
class RenderComponent : public MN::Component
{
	MN_VIRTUAL_BEGIN(RenderComponent, Component);
	MN_END
public:
